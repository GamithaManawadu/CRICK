...
class _MyHomePageState extends State<AdminMenu> with TickerProviderStateMixin {
  List<AdminList> adminList = AdminList.adminList;
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return GridView(
                            ...
                            children: List<Widget>.generate(
                              adminList.length,
                              (int index) {
                                final int count = adminList.length;
                                ...
                                return HomeListView(
                                  animation: animation,
                                  animationController: animationController,
                                  listData: adminList[index],
                                  callBack: () {
                                    Navigator.push<dynamic>(
                                      context,
                                      MaterialPageRoute<dynamic>(
                                        builder: (BuildContext context) =>
                                            adminList[index].navigateScreen!,
                                      ),
                                    );
                                  },
                                );
